...
export async function sendLike(token: string, userId: string): Promise<{ message: string; status: string }> {
  const res = await fetchWithTimeout(`${getApiBase()}/api/friends/like`, {
    method: 'POST',
    headers: {
...
export async function unlikeUser(token: string, userId: string): Promise<{ message: string; status: string }> {
  const res = await fetchWithTimeout(`${getApiBase()}/api/friends/unlike`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${token}`,
...
export async function getFriendshipStatus(token: string, userId: string): Promise<FriendshipStatus> {
  ...
  const res = await fetchWithTimeout(`${getApiBase()}/api/friends/status/${id}`, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });
...
export async function getFriendRequests(token: string): Promise<FriendRequest[]> {
  const res = await fetchWithTimeout(`${getApiBase()}/api/friends/requests`, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });
...
export async function acceptFriendRequest(token: string, userId: string): Promise<{ message: string; status: string }> {
  const res = await fetchWithTimeout(`${getApiBase()}/api/friends/accept`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${token}`,
...
export async function declineFriendRequest(token: string, userId: string): Promise<{ message: string }> {
  const res = await fetchWithTimeout(`${getApiBase()}/api/friends/decline`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${token}`,
...
export async function getFriendsList(token: string): Promise<FriendRequest[]> {
  const res = await fetchWithTimeout(`${getApiBase()}/api/friends/list`, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });
...
export async function getOutgoingLikes(token: string): Promise<FriendRequest[]> {
  const res = await fetchWithTimeout(`${getApiBase()}/api/friends/likes`, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });
...
export async function unfriend(token: string, userId: string): Promise<{ message: string }> {
  const res = await fetchWithTimeout(`${getApiBase()}/api/friends/unfriend`, {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${token}`,
...
export async function blockUser(
  ...
  const res = await fetchWithTimeout(`${getApiBase()}/api/friends/block`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${token}`,
...
export async function unblockUser(
  ...
  const res = await fetchWithTimeout(`${getApiBase()}/api/friends/unblock`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${token}`,
...
export async function getBlockedUsers(token: string): Promise<BlockedUser[]> {
  const res = await fetchWithTimeout(`${getApiBase()}/api/friends/blocked`, {
...
export async function reportUser(
  ...
  const res = await fetchWithTimeout(`${getApiBase()}/api/friends/report`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${token}`,
